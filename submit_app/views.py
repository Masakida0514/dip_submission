...
def index(request):
    ...
    # input type='files' name='hoge'　のname部がdictのキーになる
    ...
    if request.method == 'POST':
        ...
        if recruitment.is_valid():
            ...
            recruitment_info = pd.read_csv('submit_app/static/test/504_submission.csv')
            ...
            response = write_into_csv(recruitment_info)
